...
observations varied between -1.25 and 2.75. Throughout the weeks, the
experimental observations trended upwards and the control observations
remained relatively the same. The control group looks like it trended
slightly downward, but it is difficult to tell whether this is the true
effect, or due to a smaller sample size.
