...
This outcome is very surprising to me. I would expect mu = 6 to be
...
to be the same, resulting in a higher power proportion.
...
This is also very unexpected. I would have assumed to see a very direct,
linear relationship between the average mu and true mu. This graph does
not reflect this at all. With a normal sample size this large, we would
expect to see the average average to be what is expected.
...
rejected. This would make an interesting density or violin plot.
